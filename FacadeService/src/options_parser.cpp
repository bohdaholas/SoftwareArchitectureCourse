...
config_options_t::config_options_t() {
    opt_conf.add_options()
            ("facade_service_port", po::value<int>(&facade_service_port)->required())
            ("logging_service_port", po::value<int>(&logging_service_port)->required())
            ("message_service_port", po::value<int>(&message_service_port)->required())
            ;
}
